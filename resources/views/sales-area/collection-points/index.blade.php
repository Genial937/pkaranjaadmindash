        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Collection Points</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('index') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Collection Points</li>
                        </ol>
                    </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <div class="mb-3 float-end">
                                    <a href="{{ route('collection-points.create') }}" class="btn btn-success waves-effect waves-light"><i
